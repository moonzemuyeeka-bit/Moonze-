...
Values can be overridden through environment variables (prefixed ``ZATU_``)
...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="ZATU_", env_file=".env", extra="ignore")

    app_name: str = "Zatu Loan Platform"
    database_url: str = "sqlite:///./zatu.db"
